...
class EditClient extends Component {
  constructor(props) {
    ...
    // Create Refs SO that the Input Valuves ARE Connected to STATE
              ...
              <form onSubmit={this.onSubmit}>
                <div className="form-group">
                  ...
                  <input
                    ...
                    minLength="2"
                    required
                    // 'ref' Props to connect with State
...
export default compose(
  // GET single client (FB Collection)
